...
#GET LYRICS DOCS: https://developer.musixmatch.com/documentation/api-reference/track-lyrics-get
#GET TRACK ID DOCS: https://developer.musixmatch.com/documentation/api-reference/track-search
